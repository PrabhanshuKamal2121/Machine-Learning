...
# for i in range(1,11):
#     print(f"{n} * {i} = {n*i}")  
# f"..." tells Python to evaluate expressions inside curly braces {} and insert their values into the
...
# So output will be: "your number is perfect"
...
# Step-by-Step:
# 🔹 len(a)-1
# len(a) gives the length of the string a, which is 9.

# len(a)-1 is 8, which is the index of the last character 'S'.

# 🔹 -1 (second argument)
# This is the stop value, but note: range goes up to but not including this value.

# So the loop will stop when it reaches index 0, because it goes down to -1 and stops before reaching it.

# 🔹 -1 (third argument)
# This is the step. -1 means the loop will move backward, decreasing the index each time.
...
#         print("how are you")
#pehli baar run karenge toh sub run ho jayenge
...
#yeh instance ban jata hai jo object hota hai
##self meh store hota hai then usse reveal karne ke liye self.material= marterial likhte hai
...
## functions meh parameter maang sakte hai but class meh nahi thta's why we use constructor
...
#     def hello(cls):
        ...
        #  `@classmethod hello(cls)`: A class method. It tries to print `cls.age`, but `age` is not a class attribute—this would cause an error unless you define `age` at the class level.
...
# obj = Animal(12)
# print(obj.name)  # Accessing class attribute
# print(obj.age)   # Accessing instance attribute
# obj.show()  # Calling instance method
# obj.hello()  # Calling class method
